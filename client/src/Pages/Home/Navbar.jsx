...
export default function Navbar() {
  ...
  const MenuItems = () => (
    <>
      ...
      {userRole === "admin" && (
        <Link to="/AdminApplication" className="text-gray-600 hover:text-gray-900">
          Admin Application
        </Link>
      )}


      {/* Conditionally render government route */}
      {userRole === "gov" && (
        <Link to="/GovApplication" className="text-gray-600 hover:text-gray-900" aPPLICATION  />
      )}
      <div
        className="relative"
